...
#Repeat an array - np.repeat(array, howManyTimes, axis=0ifVertical or 1ifHorizontal)
arr = np.array([[1,2,3]])
...
#Do this when copying a array to another variable - to not change the source or reference variable
a = np.array([1,2,3])
b = a.copy()
b[0] = 1000
print(b)
